...
func (s RequestPrepareAnnounceTransferTransactionV1) SerializeV1() ([]byte, []byte) {
	...
	//	PublicKey Signer
	psig, _ := strconv.Atoi("4789ce4617a483c7c0b78939f79923b85ca3835369f6ecc7004a0e710179f030")
	...
	payload := []byte(s.TransferTransactionV2.Message)
	...
	dataByte := append(obyte, tTxnByte...)
}
